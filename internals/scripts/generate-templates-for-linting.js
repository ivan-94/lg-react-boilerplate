...
const ComponentEsclass = componentGen
  .runActions({
...
const ContainerComponent = containerGen
  .runActions({
...
ContainerComponent.then(() =>
  routeGen
    .runActions({
      component: 'RbGeneratedContainerComponent',
...
ComponentEsclass.then(() =>
  routeGen
    .runActions({
      component: 'RbGeneratedComponentEsclass',
